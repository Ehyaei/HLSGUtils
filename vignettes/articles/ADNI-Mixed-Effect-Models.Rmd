...
```{r,eval=FALSE}
partitions_files = list.files("/data/array/mshoai/ADprogressionData/ADNI/data_partitions/", full.names = T)[1:10] 

save_model_path = "/data/array/mshoai/ADprogressionData/ADNI/models/full_model/"
formula = "MMSE~ SEX + AGE+ MMSE.bl + PC1 +PC2 +PC3+ PTEDUCAT + copy_number + (1|PTID) + (1|VISID)"
parallel_rscripts(
